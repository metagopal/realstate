...
function CreateListing() {
  ...
  const onSubmit = async (e) => {
    ...
    if (geolocationEnabled) {
      ...
      geolocation.lat = 26.936060409245936; // data.results[0].geomatry.location.lat ?? 0;
      geolocation.lng = 75.82169963853934; // data.results[0].geomatry.location.lng ?? 0;
      ...
      if (location === undefined) {
        ...
        geolocation.lat = 26.936060409245936; // latitude;
        geolocation.lng = 75.82169963853934; // longitude;
      }
    }
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="flex items-center">
          <button
            ...
            mr-3
            px-7 py-2 font-medium text-sm uppercase shadow-md rounded
            hover:shadow-lg focus:shadlow-lg active-shadow-lg
          ...
          <button
            ...
            ml-3 px-7 py-2 font-medium text-sm uppercase shadow-md rounded
            hover:shadow-lg focus:shadlow-lg active-shadow-lg
            transition duration-150 ease-in-out w-full
            `}
          >
        ...
        px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md 
